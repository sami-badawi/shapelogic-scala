...
//  test("Redbox") {
//    val filename = "redbox";
//    val image: BufferImage[Byte] = null // new IJImage(filePath(filename,".png"));
//    val foregroundColor: Int = 0xff0000;
//    val foregroundColorClose: Int = 0xfe0000;
//    assert(image != null);
...
//    val edgeTracer: IEdgeTracer = getInstance(image, foregroundColorClose, 10, true)
...
//    val image: BufferImage[Byte] = null // = new IJImage(filePath(filename));
...
//  public void testI() {
//    String filename = "I";
//    val image: BufferImage[Byte] = null // new IJImage(filePath("./src/test/resources/images/smallThinLetters", filename, ".gif"));
//    int foregroundColor = 255;
//    assertNotNull(image);
//    assertFalse(image.isEmpty());
