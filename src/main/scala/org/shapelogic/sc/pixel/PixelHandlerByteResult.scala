 ...
 */
trait PixelHandlerByteResult[I, C] {
   ...
   */
  def calc(indexIn: Int, channelOut: Int): Byte
}

object PixelHandlerByteResult {

  /**
   * If I move the type C inside this would be useful again.
   * Now it is just an abstraction
   */
  type Aux[I, C] = PixelHandlerByteResult[I, C] {
  }
   ...
   */
  type Same[I] = PixelHandlerByteResult[I, I] {
