...
The main goal is to make it simple to write generic image processing / computer vision in Scala. While shielding the user from the advanced type machinery that makes this possible.
